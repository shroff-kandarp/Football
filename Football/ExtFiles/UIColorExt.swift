...
extension UIColor {
    ...
    public struct UCAColor {
        ...
        public static let AppThemeColor = UIColor(hex: 0x325082)
        public static let AppThemeColor_Dark = UIColor(hex: 0x284068)
        public static let AppThemeColor_Hover = UIColor(hex: 0x46618e)
        public static let AppThemeTxtColor = UIColor(hex: 0xFFFFFF)
        
        public static let AppThemeColor_1 = UIColor(hex: 0x325082)
        public static let AppThemeColor_1_Hover = UIColor(hex: 0x46618e)
        public static let AppThemeTxtColor_1 = UIColor(hex: 0xFFFFFF)
        
        public static let textFieldActiveColor = UIColor(hex: 0xFFFFFF)
        public static let textFieldDividerInActiveColor = UIColor(hex: 0xFFFFFF)
        public static let textFieldDividerActiveColor = UIColor(hex: 0xFFFFFF)
        public static let textFieldPlaceholderInActiveColor = UIColor(hex: 0xFFFFFF)
        public static let textFieldPlaceholderActiveColor = UIColor(hex: 0xFFFFFF)
